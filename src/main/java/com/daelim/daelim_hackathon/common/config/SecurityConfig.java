...
import com.daelim.daelim_hackathon.author.filter.CustomAuthenticationFilter;
import com.daelim.daelim_hackathon.author.filter.CustomAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        customAuthenticationFilter.setFilterProcessesUrl("/authors/login");
        // csrf 금지
        http.csrf().disable();
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET,"/novels", "/novels/**").permitAll()
